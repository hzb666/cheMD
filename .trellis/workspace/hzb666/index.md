...
| 202 | 2026-06-04 | Language core deepening phase 7 semantic diff state | `75c7985` | `develop` |
| 201 | 2026-06-04 | Language core deepening phase 6 diagnostic explain | `0fe69d8` | `develop` |
...
| 196 | 2026-06-04 | Language core deepening phase 1 condition AST | `cee9073` | `develop` |
...
| 185 | 2026-06-04 | Phase 13 pure core compiler entry | `e51c94b` | `develop` |
| 184 | 2026-06-03 | Phase 12 compiler diagnostic dedupe | `be5a165` | `develop` |
...
| 145 | 2026-05-23 | Archive prose step import reliability | `6aeb0f8` | `develop` |
| 144 | 2026-05-23 | Phase 6 import diagnostics docs | `2710919` | `develop` |
...
| 137 | 2026-05-23 | Prose reaction import phase 4 | `ffa37b6` | `develop` |
| 136 | 2026-05-23 | Prose reaction import phase 3 | `03edda9` | `develop` |
...
| 57 | 2026-05-13 | Desktop IDE Monaco completion provider | `62cb61b`, `7480d36`, `81e4de7` | `desktop-ide` |
| 56 | 2026-05-13 | Desktop IDE workspace symbol index core | `8dc7ffe`, `5b3d885`, `565a6de` | `desktop-ide` |
...
| 50 | 2026-05-13 | Desktop IDE offline-first third wave | `05d2f72`, `21c0999`, `b6a5a80`, `fabddb9`, `9369aef`, `d2198f0`, `0973d1e`, `2e2fdf6` | `desktop-ide` |
...
| 37 | 2026-05-12 | Desktop IDE third-wave runtime integration | `e40ff30`, `6a93b32`, `b7587b9`, `69ad65e`, `12f0925` | `desktop-ide` |
...
| 30 | 2026-04-24 | Reaction route cross-doc linking | `50b507c`, `4442658` | `develop` |
| 29 | 2026-04-24 | Chemd syntax best practices and golden record | `e34c1e1`, `b7a6b06` | `develop` |
...
| 12 | 2026-04-22 | PostgreSQL storage backend | `627a596`, `fd0d0fa` | `develop` |
...
| 4 | 2026-04-19 | 完成 chemd DSL 语义闭环与提交拆分 | `ba7fff5`, `ac2d500`, `3bd576c`, `5f105e3`, `8248e37`, `8a2d6ba` | `develop` |
| 3 | 2026-04-17 | Lint complexity cleanup | `1044638cc965a13b8f2f21bf691e22453023293f` | `develop` |
| 2 | 2026-04-17 | Implement chemd-lang v0.3 semantic core | `97d3151` | `develop` |
| 1 | 2026-04-17 | Record PR11 editor and experiment workflow merge | `a832632` | `develop` |
<!-- @@@/auto:session-history -->
