# Quality Guidelines - @chemd/renderer-html

## Required Checks

- `pnpm --filter @chemd/renderer-html test`
- `pnpm --filter @chemd/renderer-html typecheck`
...
- Add regression tests in `packages/renderer-html/tests` for every behavior change.
