# Component Guidelines - @chemd/renderer-html

## Overview

`@chemd/renderer-html` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
