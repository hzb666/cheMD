# Type Safety - @chemd/renderer-html

## Overview

Types exported from `@chemd/renderer-html` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
