# Hook Guidelines - @chemd/renderer-html

## Overview

No React hooks should live in `packages/renderer-html`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
