# Component Guidelines - @chemd/core

## Overview

`@chemd/core` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
