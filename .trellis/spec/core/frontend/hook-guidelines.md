# Hook Guidelines - @chemd/core

## Overview

No React hooks should live in `packages/core`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
