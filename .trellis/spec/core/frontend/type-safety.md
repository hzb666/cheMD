# Type Safety - @chemd/core

## Overview

Types exported from `@chemd/core` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
