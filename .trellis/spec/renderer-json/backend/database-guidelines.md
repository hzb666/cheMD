# Database Guidelines - @chemd/renderer-json

## Overview

`@chemd/renderer-json` does not own a database, ORM, migrations, Redis, or durable cache. Package logic should be deterministic and testable from input values.
