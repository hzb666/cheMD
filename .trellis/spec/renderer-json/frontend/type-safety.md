# Type Safety - @chemd/renderer-json

## Overview

Types exported from `@chemd/renderer-json` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
