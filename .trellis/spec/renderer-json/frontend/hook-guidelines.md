# Hook Guidelines - @chemd/renderer-json

## Overview

No React hooks should live in `packages/renderer-json`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
