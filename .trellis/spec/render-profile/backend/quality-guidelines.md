# Quality Guidelines - @chemd/render-profile

## Required Checks

- `pnpm --filter @chemd/render-profile test`
- `pnpm --filter @chemd/render-profile typecheck`
...
- Add regression tests in `packages/render-profile/tests` for every behavior change.
