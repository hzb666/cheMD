# Hook Guidelines - @chemd/render-profile

## Overview

No React hooks should live in `packages/render-profile`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
