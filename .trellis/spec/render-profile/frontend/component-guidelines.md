# Component Guidelines - @chemd/render-profile

## Overview

`@chemd/render-profile` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
