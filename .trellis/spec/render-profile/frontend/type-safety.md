# Type Safety - @chemd/render-profile

## Overview

Types exported from `@chemd/render-profile` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
