# Hook Guidelines - @chemd/exporter-training

## Overview

No React hooks should live in `packages/exporter-training`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
