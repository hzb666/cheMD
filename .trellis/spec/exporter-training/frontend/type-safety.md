# Type Safety - @chemd/exporter-training

## Overview

Types exported from `@chemd/exporter-training` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
