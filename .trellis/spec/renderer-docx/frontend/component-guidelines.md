# Component Guidelines - @chemd/renderer-docx

## Overview

`@chemd/renderer-docx` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
