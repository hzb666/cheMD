# Type Safety - @chemd/renderer-docx

## Overview

Types exported from `@chemd/renderer-docx` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
