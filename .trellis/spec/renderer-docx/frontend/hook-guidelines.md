# Hook Guidelines - @chemd/renderer-docx

## Overview

No React hooks should live in `packages/renderer-docx`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
