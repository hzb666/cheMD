# Database Guidelines - @chemd/renderer-docx

## Overview

`@chemd/renderer-docx` does not own a database, ORM, migrations, Redis, or durable cache. Package logic should be deterministic and testable from input values.
