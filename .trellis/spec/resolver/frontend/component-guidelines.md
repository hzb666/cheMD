# Component Guidelines - @chemd/resolver

## Overview

`@chemd/resolver` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
