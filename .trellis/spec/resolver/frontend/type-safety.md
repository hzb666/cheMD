# Type Safety - @chemd/resolver

## Overview

Types exported from `@chemd/resolver` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
