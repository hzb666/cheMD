# Database Guidelines - @chemd/parser

## Overview

`@chemd/parser` does not own a database, ORM, migrations, Redis, or durable cache. Package logic should be deterministic and testable from input values.
