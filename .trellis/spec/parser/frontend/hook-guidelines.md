# Hook Guidelines - @chemd/parser

## Overview

No React hooks should live in `packages/parser`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
