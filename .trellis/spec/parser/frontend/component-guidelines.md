# Component Guidelines - @chemd/parser

## Overview

`@chemd/parser` should not define React components. UI components live in `apps/web/src/components` or `apps/web/src/features/*/components`.
