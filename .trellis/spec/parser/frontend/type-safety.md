# Type Safety - @chemd/parser

## Overview

Types exported from `@chemd/parser` are part of the frontend consumption contract. Keep them explicit, narrow, and aligned with `@chemd/core`.
