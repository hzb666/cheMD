# Directory Structure - @chemd/compiler

## Overview

`packages/compiler` is a workspace package with a narrow public API. Keep package code in `src`, tests in `tests`, and public exports in `src/index.ts`.
