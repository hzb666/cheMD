# Hook Guidelines - @chemd/compiler

## Overview

No React hooks should live in `packages/compiler`. Package APIs must stay usable from tests, Node adapters, and browser code without React.
