...
export const BLOCK_SCHEMAS: readonly BlockSchema[] = [
  {
    ...
    fields: [
      ...
      field("reagents", { completionKinds: chemdReaction, list: true, value: listValue(participantReferenceValue) }),
      field("catalyst", { completionKinds: chemdReaction, list: true, value: listValue(participantReferenceValue) }),
      field("solvent", { completionKinds: chemdReaction, list: true, value: listValue(participantReferenceValue) }),
