...
const createPreviewScriptNonce = (): string => {
...
export const buildPreviewThemeSyncScriptTag = (nonce?: string): string =>
  `<script${nonce ? ` nonce="${nonce}"` : ""}>${PREVIEW_THEME_SYNC_SCRIPT_BODY}</script>`;
