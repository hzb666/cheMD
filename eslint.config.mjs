...
const desktopLegacyStructureFiles = [
  ...
  "apps/desktop/src/features/dock-panels/insight-content.tsx",
  ...
  "apps/desktop/src/features/workbench/workbench-shell.tsx",
  "apps/desktop/src/features/workspace-sidebar/workspace-sidebar.tsx",
