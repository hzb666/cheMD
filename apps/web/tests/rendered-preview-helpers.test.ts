...
describe("useRenderedPreview draft hydration helpers", () => {
  ...
  it("keeps cached reaction drafts when one side is intentionally empty", async () => {
    const fetchMock = async () =>
      ({
        ok: true,
        json: async () => ({
...
describe("useRenderedPreview graphic replacement helpers", () => {
...
describe("useRenderedPreview field replacement helpers", () => {
