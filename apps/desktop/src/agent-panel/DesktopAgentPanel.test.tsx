...
import type { DesktopAgentTimelinePanel } from "../desktop-agent-timeline-panel";
import { DesktopAgentPanel, canApply, canApprove, canReject } from "./DesktopAgentPanel";

const basePanel = (overrides: Partial<DesktopAgentTimelinePanel> = {}): DesktopAgentTimelinePanel => ({
  state: "running",
...
describe("DesktopAgentPanel", () => {
  it("renders summary, tool calls, patch gate, warnings, and timeline rows", () => {
    const html = renderToStaticMarkup(<DesktopAgentPanel panel={basePanel()} />);
