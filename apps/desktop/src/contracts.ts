...
export interface ChemPreviewRenderInput {
...
export interface ChemPreviewRenderOutput {
  svg?: string;
...
export interface CreateEmbeddingVectorInput {
  text: string;
}

export interface CreateEmbeddingVectorResult {
  state: EmbeddingProviderStatusState;
  label: string;
  detail: string;
  providerKind: EmbeddingProviderKind;
...
export interface CommandMap {
  ...
  render_chem_preview: {
    ...
    output: ChemPreviewRenderOutput;
  };
  set_window_maximize_button_rect: {
    input: {
      rect: WindowCaptionButtonRect | null;
    };
    output: void;
  };
