...
export type ListLocalReactionIntelligenceArtifacts = (
  input: CommandMap["list_local_reaction_intelligence_artifacts"]["input"]
) => Promise<CommandMap["list_local_reaction_intelligence_artifacts"]["output"]>;
...
export const buildListLocalReactionIntelligenceArtifactsInput = (
  graphIndexId?: string | null
): CommandMap["list_local_reaction_intelligence_artifacts"]["input"] => ({
