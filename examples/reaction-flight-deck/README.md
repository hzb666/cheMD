...
examples\reaction-flight-deck\amidation-benzylamide.chemd: 0 error(s), 0 warning(s), 0 info (5 declaration(s), 0 doc comment(s))
examples\reaction-flight-deck\screen-comparison.chemd: 0 error(s), 0 warning(s), 0 info (5 declaration(s), 0 doc comment(s))
examples\reaction-flight-deck\shared-reagents.chemd: 0 error(s), 0 warning(s), 0 info (11 declaration(s), 0 doc comment(s))
examples\reaction-flight-deck\suzuki-after.chemd: 0 error(s), 0 warning(s), 0 info (6 declaration(s), 0 doc comment(s))
examples\reaction-flight-deck\suzuki-before.chemd: 0 error(s), 0 warning(s), 0 info (6 declaration(s), 0 doc comment(s))
examples\reaction-flight-deck\suzuki-pyrimidine.chemd: 0 error(s), 0 warning(s), 0 info (5 declaration(s), 0 doc comment(s))
```
...
Chemd module link
  ...
  - demo_shared_reagents (demo-shared-reagents) examples/reaction-flight-deck/shared-reagents.chemd
  - demo_suzuki_pyrimidine (demo-suzuki-pyrimidine) examples/reaction-flight-deck/suzuki-pyrimidine.chemd
  - demo_amidation_benzylamide (demo-amidation-benzylamide) examples/reaction-flight-deck/amidation-benzylamide.chemd
  - demo_screen_comparison (demo-screen-comparison) examples/reaction-flight-deck/screen-comparison.chemd
...
Chemd incremental compile
  files: 3
  diagnostics: 0 error(s), 0 warning(s), 0 info
  - examples/reaction-flight-deck/shared-reagents.chemd: cold rev=1 0 error(s), 0 warning(s)
  - examples/reaction-flight-deck/suzuki-pyrimidine.chemd: changed rev=2 0 error(s), 0 warning(s)
  - examples/reaction-flight-deck/amidation-benzylamide.chemd: changed rev=3 0 error(s), 0 warning(s)
```
...
Chemd preflight (human-run)
  file: examples/reaction-flight-deck/suzuki-pyrimidine.chemd
  blocking: no
  issues: 18
...
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#charge] Step charge has safety tag: inventory
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#charge] Step charge has safety tag: vessel
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#add_base] Step add_base requires manual confirmation.
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#add_base] Step add_base has safety tag: hazardous_reagent
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#add_catalyst] Step add_catalyst requires manual confirmation.
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#add_catalyst] Step add_catalyst has safety tag: hazardous_reagent
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#heat] Step heat requires manual confirmation.
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#heat] Step heat has safety tag: exotherm
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#quench] Step quench requires manual confirmation.
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#quench] Step quench has safety tag: quench
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#quench] Step quench has safety tag: exotherm
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#quench] Step quench has safety tag: gas_evolution
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#extract] Step extract has safety tag: biphasic_system
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning W_RUNTIME_SAFETY [runtime_preflight step#split] Step split has safety tag: biphasic_system
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning E_RUNTIME_CONTROL [runtime_preflight procedure#operator_gate] Control operator_gate requires runtime decision: wait
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning E_RUNTIME_CONTROL [runtime_preflight procedure#overheated] Control overheated requires runtime decision: abort_if
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning E_RUNTIME_CONTROL [runtime_preflight procedure#clean_profile] Control clean_profile requires runtime decision: until
examples/reaction-flight-deck/suzuki-pyrimidine.chemd warning E_RUNTIME_CONTROL [runtime_preflight procedure#low_yield] Control low_yield requires runtime decision: abort_if
```
...
Chemd module link
  ...
  - demo_shared_reagents (demo-shared-reagents) examples/reaction-flight-deck/shared-reagents.chemd
  - demo_broken_reaction_flight_deck (demo-broken-reaction-flight-deck) examples/reaction-flight-deck/broken-demo.chemd
